...
//		private static const OBJECT_TYPE_BIT:int = 19;
      ...
      public var vOffset:Number = 0;
		 ...
		 */
		public function TrackMaterial(diffuseMap:TextureResource = null, normalMap:TextureResource = null, specularMap:TextureResource = null, glossinessMap:TextureResource = null, opacityMap:TextureResource = null) {
...
//			fragmentLinker.setInputParams(omniMulShadowProcedure, "tNormal", "tViewVector", "tTotalLight", "cAmbientColor");
		 ...
		 * @param lightsLength
		 */
		private function getProgram(object:Object3D, programs:Array, camera:Camera3D, materialKey:int, opacityMap:TextureResource, alphaTest:int, lightsGroup:Vector.<Light3D>, lightsLength:int, isFirstGroup:Boolean, shadowedLight:Light3D):TrackMaterialProgram {
			// 0 bit - lightmap
			...
			var program:TrackMaterialProgram = programs[key];
			...
			if (program == null) {
				...
				program = new TrackMaterialProgram(vertexLinker, fragmentLinker, (shadowedLight != null) ? 1 : lightsLength);
		...
		private function addDrawUnits(program:TrackMaterialProgram, camera:Camera3D, surface:Surface, geometry:Geometry, opacityMap:TextureResource, lights:Vector.<Light3D>, lightsLength:int, isFirstGroup:Boolean, shadowedLight:Light3D, opaqueOption:Boolean, transparentOption:Boolean, objectRenderPriority:int):void {
			// Buffers
		...
		override alternativa3d function collectDraws(camera:Camera3D, surface:Surface, geometry:Geometry, lights:Vector.<Light3D>, lightsLength:int, useShadow:Boolean, objectRenderPriority:int = -1):void {
			...
			// Iterate groups
			var materialKey:int;
			var program:TrackMaterialProgram;
		...
		override public function clone():Material {
			var res:TrackMaterial = new TrackMaterial(diffuseMap, normalMap, specularMap, glossinessMap, opacityMap);
		...
		override protected function clonePropertiesFrom(source:Material):void {
			...
			var sMaterial:TrackMaterial = TrackMaterial(source);
...
class TrackMaterialProgram extends ShaderProgram {
	...
	public function TrackMaterialProgram(vertex:Linker, fragment:Linker, numLigths:int) {
